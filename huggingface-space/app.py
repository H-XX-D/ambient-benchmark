            ...
            with gr.Column(scale=4, min_width=300, elem_classes="ambient-run-copy"):
                gr.HTML("""
                  ...
                  <ul class="ambient-facts">
                    ...
                    <li><b>Questions</b><span>The BEAM runner covers 10 categories: abstention, contradiction resolution, event ordering, information extraction, instruction following, knowledge update, multi-session reasoning, preference following, summarization, and temporal reasoning.</span></li>
                    <li><b>Qualification</b><span>AMBIENT’s separate architecture suite contains 15 capability probes. This hosted BEAM run does not claim to replace that suite.</span></li>
                    ...
                    <li><b>Integrity</b><span>The 400-question bundle must contain balanced sampling, 1,600 judged rows, zero reader or judge errors, uncertainty, and evidence fingerprints.</span></li>
                  </ul>
                """)
